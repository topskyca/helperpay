...
(function () {
  ...
  function settingsHtml() {
    ...
    html += '<div class="card"><h2>' + L('Privacy controls', '私隱控制') + '</h2>' +
      ...
      '<p class="muted small mt">' + L(
        'Off by default. If enabled, only coarse app events are sent to GoatCounter. Names, wages, dates, notes, payments and screenshots are never sent. You can withdraw consent at any time.',
        '預設關閉。啟用後，只會向 GoatCounter 傳送粗略的應用程式事件；姓名、薪金、日期、備註、付款及截圖絕不會傳送。你可隨時撤回同意。'
